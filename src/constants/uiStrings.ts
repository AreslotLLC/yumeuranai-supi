...
export const uiStrings = {
    home: {
        hero: {
            ...
            titleLine1: "夢が紡ぐ、",
            titleLine2: "心の物語",
            description: "眠りの中で出会う不思議な世界には、\n魂からのメッセージが隠されています。\nやさしい光に導かれ、あなたの心の声を聴きましょう。",
            ctaSearch: "夢を占う",
            ctaGuide: "知識を深める",
            altHeroMain: "夢の象徴",
        },
        ...
        featuredGuides: {
            title: "深まる、夢の知識",
            description: "夢の扉を開くための鍵を、どうぞお受け取りください。\n古の知恵と現代の心理が重なり、あなたの今日を静かに照らします。",
            viewAll: "すべての物語を見る",
            readMore: "続きを読む",
        },
        trust: {
            title: "夢と向き合う、という心",
            description: "夢と占い.jpでは、心理学的な洞察と伝統の解釈をそっと重ね合わせ、多角的な視点からあなたの心の風景を読み解きます。",
        },
        faq: {
            title: "よくあるご質問",
            items: [
    ...
    guide: {
        index: {
            ...
            heroDescription: "夢は、未来からの贈り物。\n一つひとつの記号が語りかける言葉に、そっと耳を傾けてみませんか。",
            viewAll: "全記事を見る",
        },
        article: {
    ...
    dictionary: {
        index: {
            ...
            heroDescriptionLine2: "心に残る光景を辿り、まだ見ぬあなたに出会いましょう。",
        ...
        search: {
            ...
            button: "検索",
            ctaTitle: "夢の欠片を、言葉に変えて",
            ctaDescription: "ふと心に留まったその光景。それは、何かが始まる大切な合図かもしれません。",
        ...
        detail: {
            metaTitle: (title: string) => `${title}の夢占いの意味とは？深層心理が教える暗示と心理を解説｜${siteConfig.name}`,
            metaDescription: (title: string, keywords: string) => `${title}。${keywords}の夢が暗示する意味やあなたの現状を、心理学的な視点から詳しく解説。運気向上のアドバイスも。`,
            heroDescription: (title: string) => `${title}の象徴が教える、あなたの深層心理と未来への大切なメッセージ。`,
            symbolismTitle: `夢が象徴する「${siteConfig.topicKeyword}」の意味`,
        ...
        category: {
            metaTitle: (name: string) => `${name}に関する夢占い一覧 | 意味と深層心理を検索 | ${siteConfig.name}`,
            metaDescription: (name: string) => `${name}にまつわる夢占いのキーワード一覧です。それぞれの象徴が暗示する深層心理や運勢のサインを詳しく解説しています。`,
